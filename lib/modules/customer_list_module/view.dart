...
class CustomersPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Row(
        children: [
          SideNavBar(selected: SideNavItem.customers),
          Expanded(
            child: Column(
              children: [
                _TopBar(),
...
//            Navigator.push(context, MaterialPageRoute(builder: (context) => const DeliveryRequestsPage()));
//             }),
...
class _ContentArea extends StatelessWidget {
  ...
  Widget _pagination() {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        const Text("Showing 1–5 of 1000",style: TextStyle(color: Colors.grey),),
        Row(
          children: [
